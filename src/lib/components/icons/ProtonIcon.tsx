...
// Proton Icon - Volatile asset colored token
const ProtonIcon: React.FC<ProtonIconProps> = ({ className = "w-8 h-8" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 262.27 262.27" className={className}>
      ...
      <g id="Layer_2" data-name="Layer 2">
        <g id="Layer_1-2" data-name="Layer 1">
          <circle className="proton-fill" cx="131.14" cy="131.14" r="131.11" transform="translate(-54.32 131.14) rotate(-45)" />
          <path
            className="proton-stroke"
          ...
          />
          <ellipse className="proton-stroke" cx="129.11" cy="129.8" rx="42.16" ry="111.82" transform="translate(-52.54 152.66) rotate(-52.32)" />
        </g>
      </g>
    </svg>
  );
